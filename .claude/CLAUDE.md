# `docs.renderizer` — public documentation repository

This is the **public** documentation site for `gomatic/renderizer`, created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages (and/or Cloudflare).
