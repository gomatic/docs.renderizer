[![actions](https://github.com/gomatic/docs.renderizer/actions/workflows/actions.yml/badge.svg)](https://github.com/gomatic/docs.renderizer/actions/workflows/actions.yml) [![docs](https://github.com/gomatic/docs.renderizer/actions/workflows/docs.yml/badge.svg)](https://github.com/gomatic/docs.renderizer/actions/workflows/docs.yml) [![pages](https://github.com/gomatic/docs.renderizer/actions/workflows/pages.yml/badge.svg)](https://github.com/gomatic/docs.renderizer/actions/workflows/pages.yml)

# docs.renderizer

The **public documentation** site for [`gomatic/renderizer`](https://github.com/gomatic/renderizer). Built from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs) as a self-contained [Hugo](https://gohugo.io) site, published to GitHub Pages.
